export async function getSearchRequest(query) {
    const searchUrl = `https://api.themoviedb.org/3/search/movie?api_key=e333684dcb3e9eac6a70505572519a23&language=en-US&query=${query}&page=1&include_adult=false`;
